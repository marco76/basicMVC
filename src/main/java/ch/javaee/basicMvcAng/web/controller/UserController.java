...
import ch.javaee.basicMvcAng.domain.Role;
import ch.javaee.basicMvcAng.domain.SecurityCode;
import ch.javaee.basicMvcAng.domain.User;
import ch.javaee.basicMvcAng.repository.SecurityCodeRepository;
import ch.javaee.basicMvcAng.repository.UserRepository;
import ch.javaee.basicMvcAng.service.MailSenderService;
import ch.javaee.basicMvcAng.service.MyUserDetailsService;
import ch.javaee.basicMvcAng.utility.SecureUtility;
import ch.javaee.basicMvcAng.utility.TypeActivationEnum;
import ch.javaee.basicMvcAng.web.component.UserSessionComponent;
import ch.javaee.basicMvcAng.web.form.UserForm;
